class Ability
  ...
  def initialize(user)
    ...
    if user.has_role?(Role::SUPER_ADMIN)
      ...
      can :read, :all
      can :create, [Measurement, TreatmentPlan, TreatmentSession, Testimonial]
      can :manage, [TreatmentFacility, Patient, Measurement, TreatmentPlan, TreatmentSession, Testimonial]
