...
ActiveRecord::Schema.define(:version => 20130418023853) do
  ...
  create_table "machines", :force => true do |t|
    ...
    t.boolean   "license_active",                      :default => true,  :null => false
  end
  ...
  create_table "users", :force => true do |t|
    ...
    t.timestamp "updated_at",                                                                     :null => false
    t.integer   "treatment_facility_id"
    t.string    "time_zone",              :limit => 32, :default => "Eastern Time (US & Canada)"
  end
